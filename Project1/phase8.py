...
class AI(object):
    ...
    def __init__(self, chessboard_size, color, time_out):
        ...
        self.weight_1_2 = np.array(
            [[58, -52, 47, 39, 39, 47, -52, 58],
             [-52, 16, 51, 62, 62, 51, 16, -52],
             [47, 51, 21, -33, -33, 21, 51, 47],
             [39, 62, -33, -53, -53, -33, 62, 39],
             [39, 62, -33, -53, -53, -33, 62, 39],
             [47, 51, 21, -33, -33, 21, 51, 47],
             [-52, 16, 51, 62, 62, 51, 16, -52],
             [58, -52, 47, 39, 39, 47, -52, 58]]
        ...
        self.weight_3 = np.array(
            [[48, -20, 31, 38, 38, 31, -20, 48], [-20, 19, -34, 29, 29, -34, 19, -20],
             [31, -34, 47, 23, 23, 47, -34, 31], [38, 29, 23, -10, -10, 23, 29, 38], [38, 29, 23, -10, -10, 23, 29, 38],
             [31, -34, 47, 23, 23, 47, -34, 31], [-20, 19, -34, 29, 29, -34, 19, -20],
             [48, -20, 31, 38, 38, 31, -20, 48]]
        )
        self.mobility_1_2 = np.array(
            [[-5, 34, 6, -13, -13, 6, 34, -5], [34, -29, -4, 7, 7, -4, -29, 34], [6, -4, 16, 29, 29, 16, -4, 6],
             [-13, 7, 29, 6, 6, 29, 7, -13], [-13, 7, 29, 6, 6, 29, 7, -13], [6, -4, 16, 29, 29, 16, -4, 6],
             [34, -29, -4, 7, 7, -4, -29, 34], [-5, 34, 6, -13, -13, 6, 34, -5]]
        )
        self.mobility_3 = np.array(
            [[-41, 63, 16, 48, 48, 16, 63, -41], [63, 56, -11, 12, 12, -11, 56, 63], [16, -11, 8, 6, 6, 8, -11, 16],
             [48, 12, 6, 58, 58, 6, 12, 48], [48, 12, 6, 58, 58, 6, 12, 48], [16, -11, 8, 6, 6, 8, -11, 16],
             [63, 56, -11, 12, 12, -11, 56, 63], [-41, 63, 16, 48, 48, 16, 63, -41]]
        )
