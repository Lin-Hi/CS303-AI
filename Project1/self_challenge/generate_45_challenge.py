...
if __name__ == '__main__':
    ...
    equ = 0
    i = 0
    with open('4_5_result.txt', 'r') as f:
        ...
        f.close()
    f = open('4_5_result.txt', 'a')
    try:
        while True:
            ranAI1 = phase4.AI(8, COLOR_WHITE, 5)
            ranAI2 = phase5.AI(8, COLOR_BLACK, 5)
            ...
            ranAI2 = phase5.AI(8, COLOR_WHITE, 5)
            ...
            if result_1 + result_2 > 0:
                ...
                equ += 1
            f.write(f"{i}: pha4={ran1_win}, ph5={ran2_win}, equ={equ}\n")
            print(f"{i}: pha4={ran1_win}, ph5={ran2_win}, equ={equ}")
    except BaseException:
        f.write(f"{i}: ph4={ran1_win}, ph5={ran2_win}, equ={equ}\n")
    finally:
        f.flush()
        f.close()
