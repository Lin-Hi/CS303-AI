...
if __name__ == '__main__':
    ...
    try:
        while True:
            ...
            ranAI2 = phase2.AI(8, COLOR_BLACK, 5)
            ...
            ranAI2 = phase2.AI(8, COLOR_WHITE, 5)
            ...
            if result_1 + result_2 > 0:
                ...
                equ += 1
            f.write(f"{i}: pha2={ran1_win}, ph3={ran2_win}, equ={equ}\n")
            print(i)
    except BaseException:
        f.write(f"{i}: ph2={ran1_win}, ph3={ran2_win}, equ={equ}\n")
    finally:
        f.flush()
        f.close()
