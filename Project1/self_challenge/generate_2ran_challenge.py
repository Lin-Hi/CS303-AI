...
if __name__ == '__main__':
    ...
    equ = 0
    i = 0
    with open('ran_2_result.txt', 'r') as f:
        ...
        f.close()
    f = open('ran_2_result.txt', 'a')
    try:
        while True:
            ranAI1 = phase2.AI(8, COLOR_WHITE, 5)
            ...
            ranAI1 = phase2.AI(8, COLOR_BLACK, 5)
            ...
            if result_1 + result_2 > 0:
                ...
                equ += 1
            if i % 50 == 0:
                f.write(f"{i}: pha2={ran1_win}, ran={ran2_win}, equ={equ}\n")
            print(i)
    except BaseException:
        f.write(f"{i}: ph2={ran1_win}, ran={ran2_win}, equ={equ}\n")
    finally:
        f.flush()
        f.close()
