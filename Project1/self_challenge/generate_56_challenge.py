...
if __name__ == '__main__':
    ...
    equ = 0
    i = 0
    with open('5_6_result.txt', 'r') as f:
    ...
    try:
        while True:
            ...
            if result_1 + result_2 > 0:
                ...
                equ += 1
            f.write(f"{i}: pha5={ran1_win}, ph6={ran2_win}, equ={equ}\n")
            print(f"{i}: pha5={ran1_win}, ph6={ran2_win}, equ={equ}")
    except BaseException:
        f.write(f"{i}: ph5={ran1_win}, ph6={ran2_win}, equ={equ}\n")
    finally:
        f.flush()
        f.close()
