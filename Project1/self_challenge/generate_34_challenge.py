...
if __name__ == '__main__':
    ...
    equ = 0
    i = 0
    with open('3_4_result.txt', 'r') as f:
        ...
        f.close()
    f = open('3_4_result.txt', 'a')
    try:
        while True:
            ranAI1 = phase3.AI(8, COLOR_WHITE, 5)
            ranAI2 = phase4.AI(8, COLOR_BLACK, 5)
            auto_machine_1 = Auto_Challenge(AI_white=ranAI1, AI_black=ranAI2)
            result_1 = auto_machine_1.run_game()
            ranAI1 = phase3.AI(8, COLOR_BLACK, 5)
            ranAI2 = phase4.AI(8, COLOR_WHITE, 5)
            ...
            if result_1 + result_2 > 0:
                ...
                equ += 1
            f.write(f"{i}: pha3={ran1_win}, ph4={ran2_win}, equ={equ}\n")
            print(f"{i}: pha3={ran1_win}, ph4={ran2_win}, equ={equ}")
    except BaseException:
        f.write(f"{i}: ph3={ran1_win}, ph3={ran2_win}, equ={equ}\n")
    finally:
        f.flush()
        f.close()
